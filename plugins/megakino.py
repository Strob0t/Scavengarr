...
_MAX_PAGES = _MAX_RESULTS // _RESULTS_PER_PAGE  # 50
...
class MegakinoPlugin:
    ...
    async def _verify_domain(self) -> None:
        ...
        for domain in _DOMAINS:
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    log.info("megakino_domain_found", domain=domain)
                    return
            except Exception:  # noqa: BLE001
                continue
        ...
        self._domain_verified = True
        log.warning("megakino_no_domain_reachable", fallback=_DOMAINS[0])
    ...
    async def _scrape_detail(
        ...
        if not parser.stream_links:
            log.debug("megakino_no_streams", url=detail_url)
            return None
