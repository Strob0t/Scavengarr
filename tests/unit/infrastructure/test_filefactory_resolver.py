...
class TestExtractFileId:
    ...
    def test_with_filename(self) -> None:
        url = "https://filefactory.com/file/abc123def/movie.mkv"
        assert _extract_file_id(url) == "abc123def"

    def test_www_prefix(self) -> None:
        url = "https://www.filefactory.com/file/abc123def"
        assert _extract_file_id(url) == "abc123def"

    def test_http_scheme(self) -> None:
        url = "http://filefactory.com/file/abc123def"
        assert _extract_file_id(url) == "abc123def"
    ...
    def test_wrong_path(self) -> None:
        assert _extract_file_id("https://filefactory.com/download/abc123def") is None
...
_VALID_PAGE = """
<html>
<head><title>FileFactory</title></head>
<body>
